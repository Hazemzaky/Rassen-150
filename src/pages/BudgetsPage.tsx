...
const BudgetsPage: React.FC = () => {
  ...
  const fetchBudgets = async () => {
    ...
    try {
      ...
      // Accepts either an array or an object with a 'budgets' array property
      let fetched: Budget[] = [];
      if (Array.isArray(res.data)) {
        fetched = res.data;
      } else if (res.data && Array.isArray((res.data as any).budgets)) {
        fetched = (res.data as any).budgets;
      }
      setBudgets(fetched);
    } catch (err: any) {
